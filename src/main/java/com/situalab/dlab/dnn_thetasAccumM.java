...
public class dnn_thetasAccumM extends AccumulatorV2<double[][], double[][]> implements Serializable {
    ...
    //constructor
    public dnn_thetasAccumM(int i, int j){
    ...
    public AccumulatorV2<double[][], double[][]> copy() {
        return (new dnn_thetasAccumM(iA,jA));
    }
